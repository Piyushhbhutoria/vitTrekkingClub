	<div id="ham">
		...
		<a href="index.php"><img src="../images/whitelogo.png" id="no"></a><strong>VTC</strong>
			<span id="menu">CLOSE
	...
	<div class="navi" id="nav" style="background-color: #eaeaea;">
		<span id="hid"><a href="index.php"><img src="../images/logo.png" id="no"></a><strong>VTC</strong></span>
